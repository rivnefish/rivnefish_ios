//
//  MarkerDetailsControllerOld.swift
//  RivneFish
//
...
class MarkerDetailsControllerOld: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UIScrollViewDelegate, UITextViewDelegate {
